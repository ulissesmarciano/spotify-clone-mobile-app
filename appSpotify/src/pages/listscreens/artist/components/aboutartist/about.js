...
export default function AboutArtistSection () {
    ...
    return(
        <View>
            ...
            <TouchableOpacity onPress={() => navigator.navigate("About Artist Screen")}>
                ...
                <View style={S.dataContainer}>
                    <View>
                        ...
                        <View style={S.aboutContainer} > 
                            <Text style={S.aboutArtistText}>Este Artista é um músico, cantor e compositor. Antes de se dedicar de forma excl...</Text>
                        </View>
                    </View>
